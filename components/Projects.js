...
const featuredProjects = [
  {
    href: "https://github.com/brettflora/translation-medley",
    icon:
  ...
  {
    href: "https://github.com/brettflora/poems",
    icon:
  ...
  {
    href: "https://github.com/brettflora/tools",
    icon:
...
export default function Projects() {
  return (
    <section className="mt-12 mb-4">
      <h2 className="font-black text-xl tracking-wide uppercase">
        Featured Projects
      </h2>
